...
def get_learning_speed(loss_curve):
    cutoff = 0.2   # arbitrary cutoff value for learning speed estimation
...
if __name__ == '__main__':
    ...
    #
    # directories = []
    # directories.append('../../../../Desktop/simulation november 2020/RESULTS/AMPA_scaled_only/r20_dat')
    #
    # desktop = os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop')
    # basedir = desktop + '/simulation november 2020/RESULTS/Our_params_dec_2020_3/r15_dat2KO'
    basedir = 'results/_freq/heterogen_75_r10'
